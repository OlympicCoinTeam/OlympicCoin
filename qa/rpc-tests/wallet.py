...
#   c) node1 mines 32 blocks, so now node 0 has 60001olympic, node 1 has 4250olympic, node2 has none.
#   d) node0 sends 601 olympic to node2, in two transactions (301 olympic, then 300 olympic).
