...
OlympicCoin-Project/OlympicCoin repository.
...
Setup
---------
Configuring the github-merge tool for the OlympicCoin repository is done in the following way:

    git config githubmerge.repository OlympicCoin-Project/OlympicCoin
...
A script to optimize png files in the OlympicCoin
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_olympic: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_olympic: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_olympic: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_olympic: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
