...
RESOURCES += src/qt/olympic.qrc src/qt/olympic_locale.qrc

TRANSLATIONS += src/qt/locale/olympic_bg.ts \
                src/qt/locale/olympic_de.ts \
                src/qt/locale/olympic_en.ts \
                src/qt/locale/olympic_es.ts \
                src/qt/locale/olympic_fi.ts \
                src/qt/locale/olympic_fr.ts \
                src/qt/locale/olympic_it.ts \
                src/qt/locale/olympic_ja.ts \
                src/qt/locale/olympic_pl.ts \
                src/qt/locale/olympic_pt.ts \
                src/qt/locale/olympic_ru.ts \
                src/qt/locale/olympic_sk.ts \
                src/qt/locale/olympic_sv.ts \
                src/qt/locale/olympic_vi.ts \
                src/qt/locale/olympic_zh_CN.ts \
                src/qt/locale/olympic_zh_TW.ts
