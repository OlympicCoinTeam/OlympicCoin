Contributing to OlympicCoin Core
============================

The OlympicCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the OlympicCoin Core project, and is not to be
confused with overall OlympicCoin Network Protocol consensus changes.

Whether a pull request is merged into OlympicCoin Core rests with the project merge
...
Patches that change OlympicCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the OlympicCoin consensus, it must have been
...
The project leader is the release manager for each OlympicCoin Core release.
