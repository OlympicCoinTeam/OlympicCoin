...
In order to support loading of multiple wallets in olympic-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is olympic.cpp.
...
Changes to olympic.cpp
----------------------
olympic.cpp is the entry point into olympic-qt, and as such, will require some minor modifications to provide hooks for
