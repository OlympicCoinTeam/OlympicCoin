...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop OlympicCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "OlympicCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* OlympicCoin features */
        {"olympic", "masternode", &masternode, true, true, false},
        {"olympic", "listmasternodes", &listmasternodes, true, true, false},
        {"olympic", "getmasternodecount", &getmasternodecount, true, true, false},
        {"olympic", "masternodeconnect", &masternodeconnect, true, true, false},
        {"olympic", "masternodecurrent", &masternodecurrent, true, true, false},
        {"olympic", "masternodedebug", &masternodedebug, true, true, false},
        {"olympic", "startmasternode", &startmasternode, true, true, false},
        {"olympic", "createmasternodekey", &createmasternodekey, true, true, false},
        {"olympic", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"olympic", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"olympic", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"olympic", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"olympic", "getmasternodescores", &getmasternodescores, true, true, false},
        {"olympic", "mnsync", &mnsync, true, true, false},
        {"olympic", "spork", &spork, true, true, false},
        {"olympic", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"olympic", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use olympicd, or the -server option to olympic-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> olympic-cli " + methodname + " " + args + "\n";
}
