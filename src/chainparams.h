 ...
 * OlympicCoin system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& OlympicCoinDevKey() const { return vOlympicCoinDevKey; }
    // const std::vector<unsigned char>& OlympicCoinFundKey() const { return vOlympicCoinFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vOlympicCoinDevKey;
    // std::vector<unsigned char> vOlympicCoinFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
