...
public:
    ...
    {
        // olympiccoin: the coin stake transaction is marked with the first output empty
    ...
    bool GetCoinAge(uint64_t& nCoinAge) const;  // olympiccoin: get transaction coin age
};
