/* src/config/olympic-config.h.  Generated from olympic-config.h.in by configure.  */
/* src/config/olympic-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef OlympicCoin_CONFIG_H

#define OlympicCoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "olympcoin.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "OlympicCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "OlympicCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "olympic"
