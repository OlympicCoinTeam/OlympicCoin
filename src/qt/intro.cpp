...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("OlympicCoin Core"),
     ...
     * override -datadir in the olympic.conf file in the default data directory
     * (to be consistent with olympicd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
