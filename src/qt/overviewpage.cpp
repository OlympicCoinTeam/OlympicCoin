...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcoinUnits::OLMP)
    {
    }
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->label_OlympicCoin4->setVisible(showImmature || showWatchOnlyImmature);
...
void OverviewPage::setWalletModel(WalletModel* model)
{
    ...
    if (model && model->getOptionsModel()) {
        ...
        connect(ui->blabel_OlympicCoin, SIGNAL(clicked()), this, SLOT(openMyAddresses()));

    }

    // update the display unit, to not use the default ("OlympicCoin")
    updateDisplayUnit();
}
...
void OverviewPage::updateMasternodeInfo()
{
  ...
  if (chainActive.Height() >= 0 && chainActive.Height() < 1) {
    ui->label_lcolat->setText("N/A");
    ui->label_mcolat->setText("N/A");
    ui->label_fcolat->setText("N/A");
  } else {
    ui->label_lcolat->setText("1M Coins");
    ui->label_mcolat->setText("2M Coins");
    ui->label_fcolat->setText("3M Coins");
  }
...
double BlockRewardOlympicCoin =  static_cast<double>(BlockReward/COIN);
//int64_t OlympicCoinSupply = chainActive.Tip()->nMoneySupply / COIN;
...
ui->label_CurrentBlockReward_value->setText(QString::number(BlockRewardOlympicCoin));
//ui->label_OlympicCoinSupply_value->setText(QString::number(OlympicCoinSupply));
