...
/** Utility functions used by the OlympicCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render OlympicCoin addresses in monospace font
...
// Parse "olympic:" URI into recipient object, return true on successful parsing
