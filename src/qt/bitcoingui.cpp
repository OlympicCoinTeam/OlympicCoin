...
QFontDatabase::addApplicationFont(":/fonts/olympic_font");

QString windowTitle = tr("OlympicCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a OlympicCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and OlympicCoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About OlympicCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about OlympicCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for OlympicCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your OlympicCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified OlympicCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a OlympicCoin: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the OlympicCoin Core help message to get a list with possible OlympicCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("OlympicCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to OlympicCoin network", "", count));
}
...
{
    QString strTitle = tr("OlympicCoin Core"); // default title
