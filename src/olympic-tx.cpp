...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("OlympicCoin Core olympic-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  olympic-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded OlympicCoin transaction") + "\n" +
                               "  olympic-tx [options] -create [commands]   " + _("Create hex-encoded OlympicCoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded OlympicCoin transaction
